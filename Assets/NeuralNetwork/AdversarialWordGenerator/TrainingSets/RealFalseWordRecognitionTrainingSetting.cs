...
namespace NeuralNetwork
{
    ...
    public class RealFalseWordRecognitionTrainingSetting : TrainingSettingBase
    {
        ...
        protected double[] NormalizeWord(int[] word_characters_array)
        {
            ...
            {
                result[i] = NeuralNetworkMathHelper.Map(word_characters_array[i], 0, 30, 0, 1);
            }
        ...
        public static string UnwrapWord(double[] input)
        {
            ...
            {
                float remaped_value = NeuralNetworkMathHelper.Map((float)input[i], 0, 1, 0, 30);
        ...
        protected float[] ConvertWordToFloatArray(string word)
        {
            ...
            for (int i = 0; i < word.Length; ++i)
            {
                word_array[i] = NeuralNetworkMathHelper.Map(GetLetterIndex(word[i]), 0, 30, 0, 1);
            }
            return word_array;
        }
